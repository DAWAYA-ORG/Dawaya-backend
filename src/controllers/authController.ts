...
const createSendToken = (user: any, statusCode: number, req: Request, res: Response, next: NextFunction): void => {
...
// User signup
export const signup = catchAsyncError(async (req: Request, res: Response, next: NextFunction): Promise<void> => {
